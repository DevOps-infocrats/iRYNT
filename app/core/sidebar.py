...
SIDEBAR_MENU = [
    ...
    },
    {
        ...
        'children': [
            ...
            {
                'id': 'attendance-mis-approvals',
                'key': 'mis_attendance_approvals',
                'title': 'MIS Attendance Verification',
                'endpoint': 'attendance.mis_approvals',
                'permission': 'attendance.approve',
                'page': 'mis_attendance_approvals',
                'icon': 'fact_check',
            },
            {
                'id': 'attendance-kam-approvals',
                'key': 'kam_attendance_approvals',
                'title': 'KAM Attendance Approval',
                'endpoint': 'attendance.kam_approvals',
                'permission': 'attendance.approve',
                'page': 'kam_attendance_approvals',
                'icon': 'verified',
            },
            {
