...
class DriverAttendance(db.Model):
    ...
    selfie_image_data = db.Column(db.Text, nullable=True)
    dashboard_image_data = db.Column(db.Text, nullable=True)
    ...
    approval_status = db.Column(db.String(30), nullable=True, index=True)
    seatbelt_verified = db.Column(db.Boolean, nullable=False, default=False)
    selfie_verified = db.Column(db.Boolean, nullable=False, default=False)
    dashboard_verified = db.Column(db.Boolean, nullable=False, default=False)
    odometer_verified = db.Column(db.Boolean, nullable=False, default=False)
    helmet_verified = db.Column(db.Boolean, nullable=False, default=False)
    safety_shoes_verified = db.Column(db.Boolean, nullable=False, default=False)
    safety_jacket_verified = db.Column(db.Boolean, nullable=False, default=False)
    id_card_verified = db.Column(db.Boolean, nullable=False, default=False)
    mis_verified_by = db.Column(db.String(36), db.ForeignKey('users.id', ondelete='SET NULL'), nullable=True, index=True)
    mis_verified_at = db.Column(db.DateTime(timezone=True), nullable=True)
    mis_remarks = db.Column(db.String(512), nullable=True)
    kam_verified_by = db.Column(db.String(36), db.ForeignKey('users.id', ondelete='SET NULL'), nullable=True, index=True)
    kam_verified_at = db.Column(db.DateTime(timezone=True), nullable=True)
    kam_remarks = db.Column(db.String(512), nullable=True)
